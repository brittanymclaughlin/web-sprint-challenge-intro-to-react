...
*****************************************************************
React is a Javascript library that is used to create user interfaces. It allows the programmer to develop dynamic user interfaces for the web. It is rendered in real time so it allows for more efficient developing. A common problem that it solves is that it allows for the data to be rendered as it changes, allowing the website to be responsive and functional. It is also composed of components which are small functional bits of code that can be reused many times and in doing this, React helps to keep code DRY.
*****************************************************************
1. Describe component state.
*****************************************************************
The component state inside of React is the ability for React to hold information inside the local memory to be used throughout the application. The component state also allows React to update if the data stored inside of the state changes.
*****************************************************************
1. Describe props.
*****************************************************************
Props are properties/parameters for React which allows the developer to pass information from one component to another or give the component more functionality. 
*****************************************************************
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
*****************************************************************
Side effects are used through useState or useEffect functions that allows  an outside source to affect the component such as importing information from an API. You can sync the side effects to change if a secondary value inside of the useEffect changes. This allows you to control the information coming to the application and at what time/event that it happens.
*****************************************************************
